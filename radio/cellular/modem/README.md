...
Furthermore I couldn't get the picocom or any similar tool working, so here is workaround for that.
...
```
---
The reported list of commands supported by this modem can be found on root of this repo in the `doc` folder.
